export default {
  translation: {
    ...
    authPhone: {
      ...
      button: 'Continue',
      errors: {
        sendOTP: 'Oops! We couldn\'t send the verification code. Please check your phone number and try again.'
      }
    },
    authToken: {
      ...
      button: 'Verify',
      errors: {
        verifyOTP: 'Hmm, that code doesn\'t seem right. Please double-check and try again, or request a new code.'
      }
    },
    auth: {
      ...
      errors: {
        ...
        stateChange: 'Something unexpected happened with your session. Please try signing in again.',
